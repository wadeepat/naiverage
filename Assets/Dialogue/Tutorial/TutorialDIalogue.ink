...
=== SataIntroduction ===
    ~toldName = true
    #speaker:Sata
    ส่วนข้า..ข้ามีนามว่า <color=\#DB3A34>"Sata"</color> ข้าเป็นทหารหน่วยลาดตระเวนเมือง <color=\#FF7272>Naver</color> ที่คอยดูแลความปลอดภัยของบ้านเมืองนี้ 
    ...
    #speaker:Sata
    - ถ้ากษัตริย์ที่เจ้าผู้ถึงคือ กษัตริย์ <color=\#DB3A34>Armon</color> ละก็ ข้าว่า…เขาคงช่วยไม่ได้แล้วล่ะ 
    #speaker:Me
    ทำไมล่ะ
    #speaker:Sata
