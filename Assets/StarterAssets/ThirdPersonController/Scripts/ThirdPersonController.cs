...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour, IDataPersistence
    {
        ...
        private void Start()
        {
            ...
            gameMenu = CanvasManager.instance.GetCanvasObject("GameMenu").GetComponent<GameMenu>();
            map = CanvasManager.instance.GetCanvasObject("Map").GetComponent<MapController>();
            // #if ENABLE_INPUT_SYSTEM && STARTER_ASSETS_PACKAGES_CHECKED
